package com.walker.common.redis;
...
public class XredisTemplate {
    ...
    public void setKeyValue(String key, Object value) {
        stringRedisTemplate.opsForValue().set(key, XJsonTools.toJsonString(value));
    }
    ...
    public void setKeyValueExpire(String key, Object value, long milliseconds) {
        stringRedisTemplate.opsForValue().set(key, XJsonTools.toJsonString(value), milliseconds, TimeUnit.MILLISECONDS);
    }

    public <T> T getValue(String key, Class<T> clazz) {
        String json = stringRedisTemplate.opsForValue().get(key);
        return XJsonTools.toBean(json, clazz);
    }
     ...
     * @param key
     * @param value
     * @param milliseconds unit MILLI SECONDS
     * @return
     */
    ...
    public void hashSet(String key, String hashKey, Object value) {
        stringRedisTemplate.opsForHash().put(key, hashKey, XJsonTools.toJsonString(value));
    }

    public void hashSet(String key, String hashKey, String value, Long milliseconds) {
        stringRedisTemplate.opsForHash().put(key, hashKey, value);
    ...
    public <T> T hashGet(String key, String hashKey, Class<T> clazz) {
        ...
        return XJsonTools.toBean(value, clazz);
    }
